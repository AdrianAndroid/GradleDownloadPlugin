            ...
            if (extension.debugTask) {
                ...
                project.task('efox_测试') {
                    ...
                    doLast {
                        ...
                        def str = "Confimed password doesn't macth new password"
                        println(com.duowan.efox.NodeUtils.escape(str))
//                        def pattern = '^[a-zA-Z][0-9a-zA-Z_]+\$'
//                        Node node = NodeUtils.readNodeFromLocal(new File("/Users/flannery/Desktop/yy/GradleDownloadPlugin/library2/src/main/res/values/commonstring.xml"))
//                        node.children().forEach({
//                            if (it instanceof Node) {
//                                def key = NodeUtils.getNodeKey(it)
